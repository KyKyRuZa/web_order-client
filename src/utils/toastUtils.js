...
export const AUTH_ERROR_MESSAGES = {
  ...
  'Пользователь с таким email не найден': 'Пользователь с таким email не найден',
  'Неверный пароль': 'Неверный пароль',
  'Email не подтвержден. Проверьте вашу почту.': 'Email не подтвержден. Проверьте вашу почту.',
